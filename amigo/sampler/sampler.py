...
from amigo.git_handler import get_git_diff, get_git_root_for_path, get_hexsha_active
...
from amigo.session_input import collect_user_input
            ...
            if role == "user":
                ...
                if parsed_llm_response is None:
                    raise SampleError(
                        ...
                        " Hint: Use"
                        " amigo.conversation.AmigoAssistantMessageParam"
                        " instead  of"
