...
from amigo.ctags import ensure_ctags_installed
from amigo.errors import AmigoError, ReturnToUser, SessionExit, UserError
from amigo.git_handler import get_git_root_for_path
from amigo.llm_api_handler import LlmApiHandler, is_test_environment
from amigo.logging_config import setup_logging
from amigo.revisor.revisor import revise_edits
from amigo.sampler.sampler import Sampler
from amigo.sentry import sentry_init
from amigo.session_context import SESSION_CONTEXT, SessionContext
from amigo.session_input import collect_input_with_commands
from amigo.session_stream import SessionStream
from amigo.utils import check_version, amigo_dir_path
from amigo.vision.vision_manager import VisionManager


class Session:
    """
    The server for Amigo.
    ...
    def __init__(
        ...
        if not amigo_dir_path.exists():
            os.mkdir(amigo_dir_path)
        setup_logging()
        sentry_init()
        self.id = uuid4()
