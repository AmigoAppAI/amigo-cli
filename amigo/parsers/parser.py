...
from amigo.llm_api_handler import chunk_to_lines
...
from amigo.parsers.streaming_printer import FormattedString, StreamingPrinter
...
class Parser(ABC):
    ...
    # These methods aren't abstract, since most parsers will use this impleamigoion, but can be overriden easily
