...
from amigo.terminal.prompt_session import AmigoPromptSession
from amigo.terminal.themes import themes
...
class TerminalClient:
    ...
    async def _handle_input_requests(self):
        while True:
            ...
            self.amigo_completer.command_autocomplete = (
    ...
    async def _run(self):
        ...
        self.amigo_completer = AmigoCompleter(self.session.stream)
        self._prompt_session = AmigoPromptSession(
            completer=self.amigo_completer,
