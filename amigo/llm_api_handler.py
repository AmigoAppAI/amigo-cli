...
from amigo.errors import AmigoError, ReturnToUser, UserError
...
def is_test_environment():
    ...
    benchmarks_running = os.getenv("AMIGO_BENCHMARKS_RUNNING")
    return (
...
def api_guard(func: Callable[..., Any]) -> Callable[..., Any]:
    ...
    2. Converts APIConnectionErrors to AmigoErrors
    """
...
class LlmApiHandler:
    ...
    def initialize_client(self):
        ...
        if not load_dotenv(amigo_dir_path / ".env"):
            load_dotenv()
