...
from amigo.ctags import get_ctag_lines_and_names
from amigo.diff_context import annotate_file_message, parse_diff
from amigo.errors import AmigoError
from amigo.git_handler import get_diff_for_file
from amigo.interval import INTERVAL_FILE_END, Interval
...
class CodeFeature:
    ...
    def __attrs_post_init__(self):
        if not self.path.is_absolute():
            raise AmigoError("CodeFeature path must be absolute.")
