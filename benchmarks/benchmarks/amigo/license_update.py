...
description = """
This benchmark tests the ability of Amigo to add a license to the allowed license list.
"""
...
def verify():
    try:
        import benchmark_repos.amigo.tests.license_check as license_check
