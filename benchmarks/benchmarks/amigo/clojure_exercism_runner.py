...
def verify():
    try:
        from benchmark_repos.amigo.tests.benchmarks.exercise_runners.clojure_exercise_runner import (
            ClojureExerciseRunner,
        )
        from benchmark_repos.amigo.tests.benchmarks.exercise_runners.exercise_runner_factory import (
